-- ============================================================
-- 0016 · Include shopify_draft_order in retail source filter
--
-- shopify_draft_order = admin/phone-created paid orders.
-- Shopify counts these in quantity_ordered; we now align.
-- Added to every product RPC source IN (...) clause.
-- In get_product_channel_stats it maps to the 'web' bucket (ecom).
-- ============================================================
